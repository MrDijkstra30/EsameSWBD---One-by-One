...
$stmt = $conn->prepare("SELECT c.difficolta FROM iscrizione i JOIN corso c ON i.corso = c.id WHERE i.username = ? AND c.lingua = 'italiano'");
...
<body>
    <nav class="navbar">
        ...
        <div style="display: flex; align-items: center; justify-content: center;">
            <h1 style="margin-right: 10px;">MODALITA' PRATICA DI ITALIANO </h1>
    ...
    <div class="course-container">
        ...
        <div class="footer">
            <div style="display: flex; justify-content: space-between;">
                ...
                <button class="navigate-button" onclick="location.href='http://localhost/esameSWBD/corsi/pratica/praticaIta/storico.php'">Vedi Storico</button>
            </div>
        </div>
