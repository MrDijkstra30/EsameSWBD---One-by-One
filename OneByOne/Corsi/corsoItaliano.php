...
$stmt = $conn->prepare("SELECT c.progresso FROM iscrizione i JOIN corso c ON i.corso = c.id WHERE i.username = ? AND c.lingua = 'italiano'");
...
<body>
    <nav class="navbar">
        ...
        <div style="display: flex; align-items: center; justify-content: center;">
            <h1 style="margin-right: 10px;">CORSO DI ITALIANO </h1>
    ...
    <div class="course-container">
        ...
        <div class="course-card">
            <div class="course-info">
                ...
                <p>In questa sezione troverai i concetti base della lingua italiana.</p>
                <form action="../corsi/teoria/teoriaIta.php" method="post" class="signup-form">
        ...
        <div class="course-card">
            <div class="course-info">
                ...
                <form action="pratica/praticaIta" method="post" class="signup-form">
                    <input type="hidden" name="idCorso" value="italiano">
                    <button type="submit" class="signup-button">Procedi</button>
                </form>
            </div>
        ...
        <div class="course-card">
            <div class="course-info">
                ...
                <form action="quiz/quizItaliano.php" method="post" class="signup-form" onsubmit="return checkProgress()">
                    <input type="hidden" name="idCorso" value="italiano">
                    <button type="submit" class="signup-button">Procedi</button>
                </form>
            </div>
