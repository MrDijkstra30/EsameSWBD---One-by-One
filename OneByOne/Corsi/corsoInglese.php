...
$stmt = $conn->prepare("SELECT c.progresso FROM iscrizione i JOIN corso c ON i.corso = c.id WHERE i.username = ? AND c.lingua = 'inglese'");
...
<body>
    <nav class="navbar">
        ...
        <div style="display: flex; align-items: center; justify-content: center;">
            <h1 style="margin-right: 10px;">CORSO DI INGLESE </h1>
    ...
    <div class="course-container">
        ...
        <div class="course-card">
            <div class="course-info">
                ...
                <p>In questa sezione troverai i concetti base della lingua inglese.</p>
                <form action="teoria/teoriaIng.php" method="post" class="signup-form">
        ...
        <div class="course-card">
            <div class="course-info">
                ...
                <form action="pratica/praticaIng" method="post" class="signup-form">
                    <input type="hidden" name="idCorso" value="inglese">
                    <button type="submit" class="signup-button">Procedi</button>
                </form>
            </div>
        ...
        <div class="course-card">
            <div class="course-info">
                ...
                <form action="quiz/quizInglese.php" method="post" class="signup-form" onsubmit="return checkProgress()">
                    <input type="hidden" name="idCorso" value="inglese">
                    <button type="submit" class="signup-button">Procedi</button>
                </form>
            </div>
